  ...
  return (
    <div className="container my-5 py-5">
      <div className="row">
        ...
        <div className="col-md-6">
          <img src="https://avatars.mds.yandex.net/i?id=778275644726c1a798dc3b73d7ac6407a414e565354ea1ce-5234000-images-thumbs&n=13" alt="About Us" className="img-fluid rounded" />
        </div>
      </div>
    </div>
  );

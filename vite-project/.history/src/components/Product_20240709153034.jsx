      ...
      <div className="row">
        ...
        <div className="col-md-6 d-flex flex-column justify-content-center">
          ...
          <div className="d-flex align-items-center">
            <button className="btn btn-outline-dark px-3 py-2 me-2" onClick={() => handleQuantityChange('decrease')}>-</button>
            <input type="number" value={quantity} className="form-control me-2" style={{ width: '70px' }} readOnly />
            <button className="btn btn-outline-dark px-3 py-2 me-2" onClick={() => handleQuantityChange('increase')}>+</button>

...
const SignUpForm = () => {
  ...
  const fade = useSpring({ opacity: 1, from: { opacity: 0 } }); // Define fade-in animation
  ...
  return (
    <animated.form onSubmit={handleSubmit} className="container mt-5 form-background" style={fade}>
